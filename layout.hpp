...
[L_CHARS] = LAYOUT( \
		...
		KC_TRNS,       KC_MY_UNDO,    KC_MY_CUT,         KC_MY_COPY,     KC_MY_PASTE,KC_NO,      KC_MY_L_KNOB, KC_MY_R_KNOB, KC_NO,     KC_NO,   KC_NO,   KC_NO,         KC_NO,         KC_TRNS,
...
[L_MOVE] = LAYOUT( \
		...
		KC_TRNS,       KC_MY_UNDO,    KC_MY_CUT,         KC_MY_COPY,     KC_MY_PASTE, KC_NO,      KC_MY_L_KNOB, KC_MY_R_KNOB, KC_NO,     KC_MPLY,   KC_MNXT,           KC_NO,         KC_NO,         KC_TRNS,
                                      KC_TRNS,           KC_TRNS,        KC_TRNS,     MO(L_AUX),  KC_ENT,       KC_ENT,       MO(L_AUX), KC_TRNS,   KC_TRNS,           KC_TRNS),

[L_AUX] = LAYOUT( \
		KC_SLCK,       DF(L_QWERTY),  DF(L_COLEMAK),     KC_NO,          KC_NO,      KC_NO,                                  KC_NO,   KC_NO,   KC_NO,   KC_NO,         KC_NO,         KC_PSCR,
		KC_CAPS,       BL_TOGG,       BL_STEP,           BL_BRTG,        BL_INC,     BL_DEC,                                 KC_NO,   KC_BTN1, KC_BTN1, KC_BTN2,       KC_BTN3,       KC_SYRQ,
		KC_MY_SWAP_ESC,RGB_TOG,       RGB_MOD,           RGB_SPI,        RGB_VAI,    RGB_HUI,                                KC_NO,   KC_MS_L, KC_MS_D, KC_MS_U,       KC_MS_R,       KC_PAUS,
		KC_TRNS,       KC_NO,         RGB_RMOD,          RGB_SPD,        RGB_VAD,    RGB_HUD,    KC_MY_L_KNOB, KC_MY_R_KNOB, KC_NO,   KC_ACL0, KC_ACL1, KC_ACL2,       KC_NO,         KC_NLCK,
